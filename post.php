<!DOCTYPE html>
<!--Aquí se usará el id del post que viene en la URL desde la página de inicio para mostrar el título en 
la pestaña, el contenido de ese post en la página y los comentarios relacionados con ese post-->
<?php 

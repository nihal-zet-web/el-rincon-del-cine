...
<!DOCTYPE html>
<!--Aquí mostramos el historial de comentarios de usuario si el nombre de usuario pulsado es igual al de 
la persona que está registrada (en sesión) y si no es así mostramos un mensaje para avisar de que no puede 
ver los comentarios del usuario en que ha pulsado-->
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <footer id="footer-container">
            <p>El Rincón del Cine Copyright &copy; 2026</p>
        </footer>
    </body>
</html>

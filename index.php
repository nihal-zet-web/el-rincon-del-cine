<!DOCTYPE html>
<!--Aquí cogemos cada post que hay en la base de datos y lo mostramos en la página principal
para poder acceder a cada uno usando el título tanto desde el dropdown en la barra de navegación
como desde la lista de posts-->
<?php
